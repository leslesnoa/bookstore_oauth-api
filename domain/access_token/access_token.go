...
import (
	...
	"github.com/leslesnoa/bookstore_oauth-api/utils/crypto_utils"
...
func (at *AccessTokenRequest) Validate() *restErr.RestErr {
	switch at.GrantType {
	...
	default:
		return restErr.NewBadRequestError("invalid grant_type parameter")
	}
